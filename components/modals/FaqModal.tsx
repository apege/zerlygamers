    ...
    >
      <div className="bg-white rounded-3xl border-2 border-pink-300 w-full max-w-lg p-6 shadow-2xl relative flex flex-col gap-4 text-left">
        <button
          type="button"
          onClick={onClose}
          aria-label="Tutup Pertanyaan Umum FAQ"
        ...
        <div className="flex items-center gap-2.5">
          ...
          <h3 id="faq-modal-title" className="text-base font-black text-gray-900 uppercase">Pertanyaan Umum (FAQ)</h3>
        </div>

        <div className="flex flex-col gap-2.5 text-xs text-gray-800 max-h-[60vh] overflow-y-auto">
          <div className="border border-pink-200 rounded-2xl p-3 bg-pink-50/40">
            ...
            <p className="text-gray-700 mt-1">Proses otomatis rata-rata hanya 1-5 menit setelah pembayaran terkonfirmasi.</p>
          </div>
          <div className="border border-pink-200 rounded-2xl p-3 bg-pink-50/40">
            <h4 className="font-black text-gray-900">Apakah aman dan legal?</h4>
            <p className="text-gray-700 mt-1">100% legal dan aman, menggunakan metode resmi tanpa memerlukan password akun kamu.</p>
          </div>
          <div className="border border-pink-200 rounded-2xl p-3 bg-pink-50/40">
            <h4 className="font-black text-gray-900">Bagaimana jika transaksi tertunda?</h4>
            <p className="text-gray-700 mt-1">Admin Customer Service kami aktif 24/7 siap membantu melalui tombol kontak WhatsApp.</p>
          </div>
        </div>
