        ...
        {alreadyReviewedData ? (
          ...
          <div className="py-8 text-center space-y-4 animate-in zoom-in-95 duration-200">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs sm:text-sm text-gray-600 max-w-sm mx-auto font-medium leading-relaxed">
                Kamu sudah memberikan ulasan untuk pesanan ini. Terima kasih banyak atas kepercayaanmu berbelanja di <strong className="text-pink-600">ZerlyGamers</strong>! 💖
              </p>
            </div>
            ...
            <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-2xl max-w-sm mx-auto text-xs space-y-1 text-left">
              ...
              <p className="text-[11px] text-emerald-700 font-extrabold">{alreadyReviewedData.username} • {itemPackage}</p>
            </div>
          ...
          <div className="py-8 text-center space-y-4 animate-in zoom-in-95 duration-200">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs sm:text-sm text-gray-600 max-w-sm mx-auto font-medium leading-relaxed">
                Ulasan kamu sangat berharga dan telah berhasil dipublikasikan di halaman testimoni <strong className="text-pink-600">ZerlyGamers</strong>.
              </p>
            </div>
            ...
            <div className="p-4 bg-pink-50/70 border border-pink-200 rounded-2xl max-w-sm mx-auto text-xs space-y-1">
              ...
              <p className="text-[11px] text-pink-600 font-extrabold">{username} • {itemPackage}</p>
            </div>
          ...
          <>
            ...
            <div className="space-y-1 pr-6">
              <div className="inline-flex items-center gap-1.5 text-[11px] font-black uppercase tracking-wider text-pink-600">
            ...
            <div className="p-3 bg-pink-50/60 border border-pink-200/80 rounded-2xl flex items-center justify-between text-xs">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[10px] text-gray-500 font-mono font-medium truncate">
                    Invoice: #{reviewToken.replace(/[^a-zA-Z0-9]/g, '')}
                  </div>
                </div>
              </div>
              <span className="px-2.5 py-0.5 rounded-full bg-emerald-100 text-emerald-700 text-[10px] font-black uppercase border border-emerald-200 shrink-0">
                Selesai ✓
              </span>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              <div className="space-y-1.5 text-center p-3.5 bg-gradient-to-br from-amber-50/50 to-pink-50/30 border border-amber-200/60 rounded-2xl">
                <label className="font-black text-gray-700 block">
              ...
              {/* Username Roblox */}
              <div className="space-y-1.5">
                <label className="font-bold text-gray-700">Username / Nama Kamu *</label>
                <input
                  type="text"
                  value={username}
                  onChange={(e) => setUsername(e.target.value)}
                  placeholder="Contoh: @muachiilan"
                  className="w-full px-4 py-2.5 bg-white border border-pink-200 rounded-2xl font-bold text-gray-900 focus:outline-none focus:ring-2 focus:ring-pink-400/40 focus:border-pink-400"
                  required
                />
              </div>
              ...
              {/* Review Comment */}
              <div className="space-y-1.5">
                <label className="font-bold text-gray-700">Tulis Ulasan / Testimoni Kamu *</label>
                <textarea
                  value={comment}
                  ...
                  className="w-full p-3.5 bg-white border border-pink-200 rounded-2xl text-xs font-medium text-gray-900 focus:outline-none focus:ring-2 focus:ring-pink-400/40 focus:border-pink-400 resize-none leading-relaxed"
                  required
                />
              </div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {QUICK_TAGS.map((tag) => (
                    <button
                      ...
                      className="px-2.5 py-1 rounded-xl bg-pink-50 hover:bg-pink-100 text-pink-600 text-[10px] font-bold border border-pink-200 transition-all active:scale-95 cursor-pointer"
                    >
                      + {tag}
                    </button>
                  ))}
              ...
              {/* Error Alert */}
              {errorMsg && (
                <div className="p-3 rounded-xl bg-rose-50 border border-rose-200 text-rose-600 text-[11px] font-bold">
                  {errorMsg}
                </div>
              )}
